...
abstract class Sample2{
	...
	public void display() {
		System.out.println("This is a display method inside abstract class Sampe2!");
	}
...
class Sample3 extends Sample2 implements A3,B3{
	...
	public void run(int x) {
		System.out.println("This is a run overloaded  method from abstract class Sample 3!");
	}
